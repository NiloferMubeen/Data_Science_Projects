...
st.markdown('<h1 style="text-align: center;color: #0D7F4F;">Phonepe Data Visualization and Exploration</h1>', unsafe_allow_html=True)
st.divider()

col1, col2 = st.columns(2)

with col1:
        option = st.selectbox("Top Trends Across India",("Transactions", "User"),index=0)
        tab1, tab2,tab3,tab4,tab5= st.tabs(["Categories", "Visualization","States","Districts","PostalCodes"])
        with tab1:
                st.markdown("<h4 style='text-align: left; color: #063F27;'>Merchant Payments - 58,73,01,47,618 </h4>", unsafe_allow_html=True)
                st.markdown("<h4 style='text-align: left; color: #063F27;'>Peer-to-Peer Payments - 45,18,79,71,421 </h4>", unsafe_allow_html=True)
                st.markdown("<h4 style='text-align: left; color: #063F27;'>Recharge & bill payments - 12,73,80,81,468 </h4>", unsafe_allow_html=True)
                st.markdown("<h4 style='text-align: left; color: #063F27;'>Others - 22,18,30,268 </h4>", unsafe_allow_html=True)
                st.markdown("<h4 style='text-align: left; color: #063F27;'>Financial Services - 8,74,94,775 </h4>", unsafe_allow_html=True)
        with tab2:
               ...
               fig = px.pie(user_data, values='Total_transactions', names="Categories",color_discrete_sequence=px.colors.sequential.RdBu,title = 'Transactions Type')
...
with c2:
       ...
       st.plotly_chart(fig, use_container_width=True)
st.markdown("<h3 style='text-align: center; color: #063F27;'>State Level Transactions </h3>", unsafe_allow_html=True)
a1,a2= st.columns(2)
with a1:
